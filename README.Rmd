...
Usable but not very impressive. If the R object has dimnames set, these will be used to create more informed axes:
...
The timestamp strings in the third dimension have been correctly interpreted as a time series and a `CFAxisTime` instance is created for it.
