 ...
 * **`profile()`:** Extract "profiles" from the data variable. This can take different forms, such as a temporal or depth profile for a single location, but it could also be a zonal field (such as a transect in latitude - atmosperhic depth for a given latitude) or some other profile in the physical space of the data variable.
