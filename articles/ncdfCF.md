...
of a dimension you’d have to call `var.get.nc()` or `ncvar_get()`.
Neither package loads the attributes of the dimensions, variables and
the data set (“global” variables), which is essential to *understand*
what the dimensions and variables represent.
...
#> Resource   : /home/runner/work/_temp/Library/ncdfCF/extdata/ERA5land_Rwanda_20160101.nc 
#> Format     : offset64 
...
`var.get.nc()` or `ncvar_get()`. That may be feasible for longitude and
