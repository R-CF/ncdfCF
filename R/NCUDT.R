...
#'   user-defined types in a netCDF file. Interpretation of the UDT typically
#'   requires knowledge of the data set or application.
#'
#' @docType class
#'
#' @name NCUDT
...
NCUDT <- R6::R6Class("NCUDT",
  ...
  public = list(
    ...
    #' @field size Size in bytes of a single item of the type (or a single element of a "vlen").
    size = 0L,
    ...
    #' Create a new netCDF user-defined type
    #'
    #' This class represents a user-defined type. It is instantiated when
    ...
    #' "opaque", or "vlen".
    #' @param size Size in bytes of a single item of the type (or a single element of a "vlen").
