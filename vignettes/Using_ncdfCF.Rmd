...
interoperability, several "conventions" have been developed over the years such
that users of NetCDF data can correctly interpret what data developers have put
in the resource. The most important of the conventions is the 
[CF Metadata Conventions](https://cfconventions.org). These conventions define a
